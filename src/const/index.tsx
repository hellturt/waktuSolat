...
export const LOCATION_LIST: LocationList = {
    ...
    'Sarawak': [
        { label: 'Bau', value: 'swk-0' },
        { label: 'Bekenu', value: 'swk-1' },
        { label: 'Belaga', value: 'swk-2' },
        { label: 'Belawai', value: 'swk-3' },
        { label: 'Belingan', value: 'swk-4' },
        { label: 'Betong', value: 'swk-5' },
        { label: 'Bintulu', value: 'swk-6' },
        { label: 'Bitangor', value: 'swk-7' },
        { label: 'Dalat', value: 'swk-8' },
        { label: 'Daro', value: 'swk-9' },
        { label: 'Debak', value: 'swk-10' },
        { label: 'Engkelili', value: 'swk-11' },
        { label: 'Igan', value: 'swk-12' },
        { label: 'Julau', value: 'swk-13' },
        { label: 'Kabong', value: 'swk-14' },
        { label: 'Kanowit', value: 'swk-15' },
        { label: 'Kapit', value: 'swk-16' },
        { label: 'Kuching', value: 'swk-17' },
        { label: 'Lawas	', value: 'swk-18' },
        { label: 'Limbang', value: 'swk-19' },
        { label: 'Lingga', value: 'swk-20' },
        { label: 'Lundu', value: 'swk-21' },
        { label: 'Marudi', value: 'swk-22' },
        { label: 'Matu', value: 'swk-23' },
        { label: 'Meludam', value: 'swk-24' },
        { label: 'Miri', value: 'swk-25' },
        { label: 'Niah', value: 'swk-26' },
        { label: 'Oya', value: 'swk-27' },
        { label: 'Pusa', value: 'swk-28' },
        { label: 'Rajang', value: 'swk-29' },
        { label: 'Roban', value: 'swk-30' },
        { label: 'Samarahan', value: 'swk-31' },
        { label: 'Saratok', value: 'swk-32' },
        { label: 'Sarikei', value: 'swk-33' },
        { label: 'Sebauh', value: 'swk-34' },
        { label: 'Sebuyau', value: 'swk-35' },
        { label: 'Sematan', value: 'swk-36' },
        { label: 'Serian', value: 'swk-37' },
        { label: 'Sibu', value: 'swk-38' },
        { label: 'Sibuti', value: 'swk-39' },
        { label: 'Simunjan', value: 'swk-40' },
        { label: 'Song', value: 'swk-41' },
        { label: 'Spaoh', value: 'swk-42' },
        { label: 'Sri Aman', value: 'swk-43' },
        { label: 'Sundar', value: 'swk-44' },
        { label: 'Tatau', value: 'swk-45' },
        { label: 'Terusan', value: 'swk-46' }
    ],
    'Selangor': [
